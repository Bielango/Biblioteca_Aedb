namespace Sistema_Biblioteca.Windows
{
    partial class FrmGerirUsuario
    {
        ...
        private void InitializeComponent()
        {
            ...
            Cargo = new DataGridViewCheckBoxColumn();
            ...
            toolTip1.SetToolTip(TxtCodigo, "Código numérico do GerirUsuario");
            ...
            TxtNome.TabIndex = 3;
            toolTip1.SetToolTip(TxtNome, "Nome do GerirUsuario do filme");
            ...
            Text = "Cadastro de GerirUsuario de Filme";
        ...
        private DataGridViewCheckBoxColumn Cargo;
